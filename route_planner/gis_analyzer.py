...
def generate_routes_from_db(params: dict) -> List[dict]:
    ...
    route_configs = [
        {
            "name": "路线A：椰风寨-灯塔-海滨步道环线",
            "highlight": "途经椰风寨公园和海滨步道，终点灯塔观景台，海景绝佳，路面平缓",
            # 强制锤点：椰风寨公园内道 → 灯塔南端 → 海滨步道中段
            "waypoints": [1090, 1003, 2071, 1082, 1083, 1084, 1085],
            "route_id": "ROUTE_A",
        },
        {
            "name": "路线B：环岛路-胡里山-黄厝大环线",
            "highlight": "沿环岛路主线向东，途经胡里山炮台和黄厝海滨，水站最多，风景最佳",
            # 强制锤点：环岛路主线 → 胡里山 → 黄厝西入口（不走到黄厝最东）
            "waypoints": [1030, 1040, 1042, 2001],
            "route_id": "ROUTE_B",
        },
        {
            "name": "路线C：白城-环岛路北段-菲林路大环线",
            "highlight": "向北经白城沙滩，沿菲林路返回，树茵最多，路面最友好",
            # 强制锤点：白城 → 菲林路 → 环岛路北段中段
            "waypoints": [1010, 1012, 1070, 2034, 2033],
            "route_id": "ROUTE_C",
        },
    ]
